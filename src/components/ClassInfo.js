    ...
    render() {
        ...
        return (
            <Card className={classes.container}>
                <img src={this.props.chefImg} className={classes.background_img} alt='Class thumbnail' />
                <Box display="flex" alignItems="center" fontSize="1.6rem" flexDirection="column">
