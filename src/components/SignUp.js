...
class SignUp extends Component {
    ...
    submitSignUp = (event) => {
        ...
        var firebaseAuthPromise = window.firebaseAuth.createUserWithEmailAndPassword(this.state.email, this.state.password);
    ...
    render() {
        ...
        return (
            <Box width="100%" pl="2.4rem" pr="2.4rem" pt="2.4rem" className={classes.container}>
                <Box className={classes.loginWith}>
                    <Button variant="contained" className={classes.fbButton} size="large" onClick={() => this.signUpWith("facebook")}>
                    ...
                    <Button variant="contained" className={classes.googleButton} size="large" onClick={() => this.signUpWith("google")}>
                        <Box pr="0.7rem" display="flex">
                ...
                <form className={classes.container} autoComplete="on" onSubmit={this.submitSignUp}>
                    ...
                    <Button variant="contained" color="primary" className={classes.signUpBtn} onClick={this.submitSignUp}>
